import {
  ...
  tsxLanguage,
  typescriptLanguage
} from "./chunk-ZE2USDXI.js";
import "./chunk-TB45IHSL.js";
import {
  ContextTracker,
  ExternalTokenizer,
  LRParser,
  LocalTokenGroup
} from "./chunk-W43U35N5.js";
import {
  EditorSelection,
  EditorView,
  IterMode,
...
function tagNameAfter(input, offset) {
  ...
  while (isSpace2(next)) next = input.peek(++offset);
  let name = "";
  for (; ; ) {
...
function completeAttrValue(state, schema, tree, from2, to) {
  ...
  if (nameNode) {
    ...
    if (attrs) {
      let base = state.sliceDoc(from2, to).toLowerCase(), quoteStart = '"', quoteEnd = '"';
      if (/^['"]/.test(base)) {
        token = base[0] == '"' ? /^[^"]*$/ : /^[^']*$/;
        quoteStart = "";
...
var autoCloseTags = EditorView.inputHandler.of((view, from2, to, text, insertTransaction) => {
